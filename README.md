...
стеке, — а прописывает его в Prowlarr [`app/wire.py`](app/wire.py), без тегов:
в Prowlarr прокси без тегов действует на все индексеры, а с тегом человеку
пришлось бы догадаться проставить его руками.

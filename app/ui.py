...
class App(tk.Tk):
    ...
    def _fill_help(self, command: str) -> None:
        ...
        blocks = [
            ...
            "",
            ("Если сразу после установки «Test» отвечает «Name does not resolve» — "
             "это не блокировка сайта и не ошибка в адресе. Сеть внутри "
             "медиасервера поднимается на полминуты дольше самих сервисов. "
             "Подождите минуту и нажмите «Test» ещё раз."),
            "",
